...
class Select extends BaseComponent {
    ...
    constructor(rootElement) {
        ...
        this.originalControlElement = this.rootElement.querySelector(this.selector.originalControl)
        this.buttonElement =  this.rootElement.querySelector(this.selector.button)
        this.dropdownElement = this.rootElement.querySelector(this.selector.dropdown)
        this.optionElements = this.dropdownElement.querySelectorAll(this.selector.option)
    ...
    onClick = (event) => {
        ...
        const isOutsideDropdownClick = target.closest(this.selector.dropdown) !== this.dropdownElement
        ...
        const isOptionClick = target.matches(this.selector.option)
